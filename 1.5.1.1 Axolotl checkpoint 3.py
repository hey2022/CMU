...
def main():
    ...
    Rect(0, 100, 400, 300, fill=gradient("aliceBlue", "deepSkyBlue", start="top-left"), opacity=35)

    # Draw the sign on the tank.
    # Place Your Code Here #
    Rect(275, 115, 120, 20, fill="ghostWhite", border="lightgrey")
    Label("Axel the Axolotl", 335, 125, size=15, italic=True, font="arial", fill="black")
